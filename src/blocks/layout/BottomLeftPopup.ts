...
export const BottomLeftPopup: Block = {
  ...
  imageURL: 'https://via.placeholder.com/600x400?text=Bottom+Left+Popup',
  imageAltText:
    'Elegant bottom-left notification popup with Japanese minimalist design. Features glassmorphism, customizable content, auto-show behavior, and smooth animations. Perfect for announcements, promotions, or gentle CTAs.',
  interfaceName: 'LayoutBottomLeftPopupBlock',
  fields: [
    {
      name: 'enabled',
      type: 'checkbox',
