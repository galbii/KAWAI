...
export function TransformationSlide({ onOpenBundle }: TransformationSlideProps = {}) {
  ...
  const handleDealerLinkClick = () => {
    trackDealerLinkClick('es60_landing_page_transformation');
  };

  // Handle bundle button click tracking
  const handleBundleClick = () => {
    if (onOpenBundle) {
      trackBundlePopupOpen('es60_landing_page_transformation');
      onOpenBundle();
    }
  };
