...
export function ShowroomLocation() {
  ...
  const showroomInfo = {
    name: 'Kawai Piano Gallery Arlington',
    address: '601 W Plano Pkwy, Ste 153, Plano, TX 75075',
    website: 'https://www.kawaipianosdallas.com/',
    phone: '(972) 645-2514',
    serviceArea: 'Serving Arlington, Texas and surrounding areas',
    hours: [
              ...
              <div className="lg:col-span-3 relative">
                <div className="w-full h-[600px]">
                  <iframe
                    ...
                    src={`https://www.google.com/maps/embed/v1/place?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}&q=601+W+Plano+Pkwy+Ste+153+Plano+TX+75075&zoom=15`}
                  />
                </div>
              </div>
