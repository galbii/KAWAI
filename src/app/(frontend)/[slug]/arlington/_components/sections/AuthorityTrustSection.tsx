        ...
        <div className="text-center mb-16 space-y-4">
          <div className="inline-flex items-center gap-3 bg-amber-50 border border-amber-200 rounded-full px-4 py-2">
            <div className="w-6 h-6 bg-amber-500 rounded-full flex items-center justify-center">
              <span className="text-white font-bold text-xs">UTA</span>
            </div>
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Our exclusive partnership with University of Texas at Arlington Music Department brings you institutional credibility and expert-approved piano selections.
          </p>
        </div>
            ...
            <CardHeader className="pb-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-600">University of Texas at Arlington</p>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <blockquote className="text-muted-foreground italic mb-4">
                &ldquo;Our partnership with Kawai ensures that our students and the Arlington community have access to exceptional piano quality that meets our institutional performance standards.&rdquo;
              </blockquote>
