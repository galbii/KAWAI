...
const featuredPianos: FeaturedPiano[] = [
  {
    ...
    model: "ES-120",
    title: "Kawai ES-120",
    description: "Compact digital piano with Responsive Hammer Compact action, 88 weighted keys, and premium piano sounds. Perfect for Arlington piano lessons, home practice, and portable performances.",
  ...
  },
  {
    ...
    model: "K-200",
    title: "Kawai K-200",
    description: "Professional upright piano with premium spruce soundboard, responsive action, and rich, resonant tone. Popular choice for Arlington piano families, serious students, teachers, and music institutions.",
        ...
        <div className={`grid lg:grid-cols-2 gap-4 lg:gap-6 items-center ${
          ...
          <div className={`relative ${isEven ? 'order-1 lg:order-2' : 'order-1 lg:col-start-1'}`}>
            <div className={`relative transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-6 scale-95'}`}>
              <Image
                src={piano.image}
                alt={`${piano.title} - Arlington Piano Sales - Available at KAWAI Piano Store Arlington`}
                width={800}
                height={600}
