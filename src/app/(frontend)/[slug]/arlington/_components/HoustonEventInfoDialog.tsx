...
interface ArlingtonEventInfoDialogProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function ArlingtonEventInfoDialog({ isOpen, onClose }: ArlingtonEventInfoDialogProps) {
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="text-center py-6 space-y-4">
            ...
            <p className="text-gray-600">
              You&apos;ll receive exclusive Arlington event details and special offers within 24 hours.
            </p>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle className="text-kawai-red">Arlington Piano Event Information</DialogTitle>
        </DialogHeader>
