        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-4" style={{ color: '#3C3530' }}>
                Concert Grand
                <span className="block">Sound.</span>
                <span className="block font-light text-4xl lg:text-5xl" style={{ color: '#E11922' }}>
                  $499.
                </span>
              </h1>
            </motion.div>
            ...
            >
              Experience authentic Shigeru Kawai SK-EX concert grand samples in an ultra-portable design. 
              Professional sound quality that inspires musicians of all levels.
            </motion.p>
