...
const BENEFITS = [
  {
    ...
    title: 'Beautiful showroom Tour',
    description: 'Experience everything from digital keyboard to concert grand pianos as well as the baby grand piano for your personal space.'
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              >
                Reserve your spot for exclusive financing offers as well as free delivery and tuning services. Available with your invitation and booking ONLY.
              </motion.p>
            </div>
