          ...
          <div className="max-w-7xl mx-auto px-8 py-2.5 flex items-center gap-6">
            {!isLanding && (
              <Link
                ...
                className="flex-shrink-0 inline-flex items-center gap-2 text-kawai-charcoal/40 hover:text-kawai-charcoal/70 transition-colors duration-200 text-[11px] tracking-[0.2em] uppercase font-[family-name:var(--font-brand-sans)]"
              >
