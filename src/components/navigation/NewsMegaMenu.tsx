        ...
        >
          ...
          {latestPosts.length > 0 && (
            <div className="bg-white border-t border-kawai-neutral">
              ...
              {/* All Stories CTA + Social links */}
              <div className="px-6 py-5 border-t border-kawai-neutral flex items-center justify-between gap-6">
                <Link
                  href="/blog"
                  onClick={onClose}
                  className="group inline-flex items-center gap-3 rounded-full bg-kawai-red border border-white/20 text-white px-5 py-3 hover:border-white/50 hover:shadow-[0_0_24px_rgba(225,25,34,0.55),0_4px_16px_rgba(225,25,34,0.35)] hover:brightness-110 hover:scale-[1.04] shadow-[0_2px_12px_rgba(225,25,34,0.3)] transition-all duration-200 shrink-0"
                >
                  <span
                ...
                <div className="flex items-center gap-3">
                  <span
                    className="text-kawai-charcoal/30 font-[family-name:var(--font-brand-sans)] uppercase shrink-0"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      aria-label="Facebook"
                      className="w-7 h-7 rounded-full bg-[#1877F2] flex items-center justify-center transition-transform duration-200 hover:scale-110"
                    >
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      aria-label="TikTok"
                      className="w-7 h-7 rounded-full bg-[#010101] flex items-center justify-center transition-transform duration-200 hover:scale-110"
                    >
                    ...
                    <a
                      ...
                      className="w-7 h-7 rounded-full bg-black flex items-center justify-center transition-transform duration-200 hover:scale-110"
                    >
